...
## Example how to create your own personal proxy server
 ...
 Optional: Before above, you can change your remote default mles.io Mles server default endpoint by changing line `const SRV_ADDR: &str = "35.157.221.129:8077"; // mles.io` to preferred (this will be a cmd parameter later on).
